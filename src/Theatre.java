...
public class Theatre {
    ...
    public static void main(String[] args) {
        ...
        Show show = new Show("Обычный спектакль", 120, "Александр Горский");
        Opera opera = new Opera("Оперный", 90, "Юрий Григорович", 20, "Пётр Чайковский", "текст либретто");
        Ballet ballet = new Ballet("Балет", 60, "Александр Горский", "Пётр Чайковский", "Текст либретто", "Лев Лукин");
        ...
        if (show.isActorExists(actor1)) {
            ...
            System.out.println("Актёр " + actor1.getName() + " " + actor1.getSurname() + " заменён на актёра " + actor2.getName() + " " + actor2.getSurname() + ".");
        } else {
